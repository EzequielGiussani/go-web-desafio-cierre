...
type RepositoryTicketMock struct {
	...
	FuncGet func() (t map[int]ticket.TicketAttributes, err error)
	// FuncGetTicketsByDestinationCountry
	FuncGetTicketsByDestinationCountry func(country string) (t map[int]ticket.TicketAttributes, err error)
...
func (r *RepositoryTicketMock) Get(ctx context.Context) (t map[int]ticket.TicketAttributes, err error) {
	// spy
	r.Spy.Get++
...
func (r *RepositoryTicketMock) GetTicketByDestinationCountry(ctx context.Context, country string) (t map[int]ticket.TicketAttributes, err error) {
	// spy
